...
All models listed have GGUF variants available on HuggingFace. Search `[model name] abliterated GGUF` or visit the [ForsakenAI uncensored database](/uncensored) for direct links and curated quant options.
