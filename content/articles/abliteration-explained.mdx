...
The HuggingFace community maintains a large collection of abliterated GGUFs. Search terms that reliably find them: `abliterated`, `uncensored`, `ablation`. The DefiledAI [uncensored model database](/uncensored) maintains a curated list with quality scores and direct links.
