export const metadata = { title: "Sign Up — DefiledAI" };
    ...
    <main className="min-h-screen bg-[#050816] text-white flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <div className="text-zinc-500 text-sm">Join the Research Network</div>
        </div>
        <div className="border border-zinc-800 p-8">
          <div className="space-y-4">
            <div>
              <label className="block text-xs text-zinc-400 uppercase tracking-widest mb-2">Username</label>
              <input type="text" placeholder="neuralrig"
          ...
          <div className="mt-6 text-center text-xs text-zinc-600">
            ...
            <a href="/login" className="text-cyan-400 hover:text-cyan-300">Login</a>
          </div>
        </div>
      </div>
    </main>
